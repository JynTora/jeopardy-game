...
const categoriesRound1 = [
  {
    name: "தமிழ் சினிமா",
    questions: [
      { value: 100, question: "\"சூப்பர் ஸ்டார்\" என்ற பட்டம் பெற்ற நடிகர் யார்?", answer: "ரஜினிகாந்த்" },
      { value: 200, question: "\"தளபதி\" என்று அன்பர்களால் அழைக்கப்படும் நடிகர் யார்?", answer: "விஜய்" },
      { value: 300, question: "\"பொன்னியின் செல்வன்\" திரைப்படத்தின் இயக்குநர் யார்?", answer: "மணிரத்னம்" },
      { value: 400, question: "ஆஸ்கர் விருது பெற்ற தமிழ் இசையமைப்பாளர் யார்?", answer: "ஏ.ஆர். ரஹ்மான்" },
      { value: 500, question: "\"இந்தியன்\", \"முதல்வன்\", \"அந்நியன்\" படங்களை இயக்கியவர் யார்?", answer: "ஷங்கர்" },
    ],
  },
  {
    name: "தமிழ் பண்பாடு",
    questions: [
      { value: 100, question: "பொங்கல் பண்டிகை எந்த மாதத்தில் கொண்டாடப்படுகிறது?", answer: "ஜனவரி (தை மாதம்)" },
      { value: 200, question: "தீபாவளி அன்று காலையில் முதலில் என்ன செய்வது வழக்கம்?", answer: "எண்ணெய் குளியல்" },
      { value: 300, question: "\"ஜல்லிக்கட்டு\" என்றால் என்ன?", answer: "காளை அடக்கும் விளையாட்டு" },
      { value: 400, question: "தமிழ் திருமணத்தில் மணமகன் மணமகளுக்கு என்ன கட்டுவான்?", answer: "தாலி" },
      { value: 500, question: "தமிழ் புத்தாண்டு எந்த மாதத்தில் வருகிறது?", answer: "ஏப்ரல் (சித்திரை மாதம்)" },
    ],
  },
  {
    name: "தமிழ் உணவு",
    questions: [
      { value: 100, question: "இட்லிக்கு பொதுவாக என்ன தொட்டுக்கொள்வோம்?", answer: "சாம்பார் & சட்னி" },
      { value: 200, question: "பொங்கல் பண்டிகையில் சமைக்கப்படும் இனிப்பு உணவு எது?", answer: "சர்க்கரைப் பொங்கல்" },
      { value: 300, question: "தோசை மாவு எதிலிருந்து தயாரிக்கப்படுகிறது?", answer: "அரிசி & உளுந்து" },
      { value: 400, question: "\"செட்டிநாடு சிக்கன்\" எந்த பகுதியின் சிறப்பு உணவு?", answer: "செட்டிநாடு (சிவகங்கை)" },
      { value: 500, question: "\"பாயசம்\" செய்ய முக்கிய இனிப்புப் பொருள் என்ன?", answer: "வெல்லம் (அல்லது சர்க்கரை)" },
    ],
  },
  {
    name: "யார் இது?",
    questions: [
      { value: 100, type: "image", question: "இவர் யார்?", answer: "ரஜினிகாந்த்", imageUrl: "/images/questions/r1_wer_100.jpg" },
      { value: 200, type: "image", question: "இவர் யார்?", answer: "ஏ.ஆர். ரஹ்மான்", imageUrl: "/images/questions/r1_wer_200.jpg" },
      { value: 300, type: "image", question: "இவர் யார்?", answer: "எம்.எஸ். தோனி", imageUrl: "/images/questions/r1_wer_300.jpg" },
      { value: 400, type: "image", question: "இவர் யார்?", answer: "சிவாஜி கணேசன்", imageUrl: "/images/questions/r1_wer_400.jpg" },
      { value: 500, type: "image", question: "இவர் யார்?", answer: "பாரதியார்", imageUrl: "/images/questions/r1_wer_500.jpg" },
    ],
  },
  {
    name: "மதிப்பீடு",
    questions: [
      { value: 100, type: "estimate", timeLimit: 30, question: "தமிழ் மொழி எத்தனை ஆண்டுகள் பழமையானது?", answer: "2500" },
      { value: 200, type: "estimate", timeLimit: 30, question: "தமிழ்நாட்டின் மக்கள் தொகை எவ்வளவு கோடி?", answer: "8" },
      { value: 300, type: "estimate", timeLimit: 30, question: "ரஜினிகாந்த் இதுவரை எத்தனை படங்களில் நடித்துள்ளார்?", answer: "170" },
      { value: 400, type: "estimate", timeLimit: 35, question: "உலகில் எத்தனை கோடி பேர் தமிழ் பேசுகிறார்கள்?", answer: "8" },
      { value: 500, type: "estimate", timeLimit: 40, question: "சென்னையின் மக்கள் தொகை எத்தனை லட்சம்?", answer: "100" },
    ],
  },
];
...
const categoriesRound2 = [
  {
    name: "தமிழ் வரலாறு",
    questions: [
      { value: 100, question: "தமிழ்நாட்டின் தலைநகரம் எது?", answer: "சென்னை" },
      { value: 200, question: "\"தமிழ்த் தேசியக் கவிஞர்\" என்று அழைக்கப்படுபவர் யார்?", answer: "பாரதியார்" },
      { value: 300, question: "சோழ மன்னர்கள் கட்டிய தஞ்சையில் உள்ள புகழ்பெற்ற கோயில் எது?", answer: "பிரகதீஸ்வரர் கோயில் (பெரிய கோயில்)" },
      { value: 400, question: "\"பெரியார்\" என்று அழைக்கப்படுபவர் யார்?", answer: "ஈ.வெ.ரா. பெரியார் (இராமசாமி)" },
      { value: 500, question: "இலங்கையில் தமிழர்கள் அதிகம் வாழும் நகரம் எது?", answer: "யாழ்ப்பாணம்" },
    ],
  },
  {
    name: "தமிழ்நாடு",
    questions: [
      { value: 100, question: "மதுரையின் புகழ்பெற்ற கோயில் எது?", answer: "மீனாட்சி அம்மன் கோயில்" },
      { value: 200, question: "ஊட்டியின் மற்றொரு பெயர் என்ன?", answer: "உதகமண்டலம்" },
      { value: 300, question: "\"கோவில் நகரம்\" என்று அழைக்கப்படும் நகரம் எது?", answer: "காஞ்சிபுரம்" },
      { value: 400, question: "ராமேஸ்வரம் எதற்கு புகழ்பெற்றது?", answer: "ராமநாதசுவாமி கோயில் (ஜோதிர்லிங்கம்)" },
      { value: 500, question: "தமிழ்நாட்டின் மிக நீளமான நதி எது?", answer: "காவிரி" },
    ],
  },
  {
    name: "தமிழ் இலக்கியம்",
    questions: [
      { value: 100, question: "தமிழ் எழுத்துக்களில் உயிர் எழுத்துக்கள் எத்தனை?", answer: "12" },
      { value: 200, question: "\"திருக்குறள்\" எழுதியவர் யார்?", answer: "திருவள்ளுவர்" },
      { value: 300, question: "\"சிலப்பதிகாரம்\" எழுதியவர் யார்?", answer: "இளங்கோவடிகள்" },
      { value: 400, question: "தமிழில் மெய் எழுத்துக்கள் எத்தனை?", answer: "18" },
      { value: 500, question: "\"கம்பராமாயணம்\" எழுதியவர் யார்?", answer: "கம்பர்" },
    ],
  },
  {
    name: "யார்/என்ன இது?",
    questions: [
      { value: 100, type: "image", question: "இவர் யார்?", answer: "விஜய்", imageUrl: "/images/questions/r2_wer_100.jpg" },
      { value: 200, type: "image", question: "இது என்ன கோயில்?", answer: "மீனாட்சி அம்மன் கோயில்", imageUrl: "/images/questions/r2_wer_200.jpg" },
      { value: 300, type: "image", question: "இவர் யார்?", answer: "தனுஷ்", imageUrl: "/images/questions/r2_wer_300.jpg" },
      { value: 400, type: "image", question: "இது என்ன கோயில்?", answer: "தஞ்சை பெரிய கோயில்", imageUrl: "/images/questions/r2_wer_400.jpg" },
      { value: 500, type: "image", question: "இவர் யார்?", answer: "கமல்ஹாசன்", imageUrl: "/images/questions/r2_wer_500.jpg" },
    ],
  },
  {
    name: "மதிப்பீடு",
    questions: [
      { value: 100, type: "estimate", timeLimit: 30, question: "திருக்குறளில் எத்தனை குறள்கள் உள்ளன?", answer: "1330" },
      { value: 200, type: "estimate", timeLimit: 30, question: "ஏ.ஆர். ரஹ்மான் எத்தனை படங்களுக்கு இசையமைத்துள்ளார்? (தோராயமாக)", answer: "150" },
      { value: 300, type: "estimate", timeLimit: 30, question: "தமிழ் சினிமாவின் முதல் படம் எந்த வருடம் வெளியானது?", answer: "1931" },
      { value: 400, type: "estimate", timeLimit: 35, question: "இலங்கையில் எத்தனை சதவீத மக்கள் தமிழர்கள்?", answer: "15" },
      { value: 500, type: "estimate", timeLimit: 40, question: "தமிழில் மொத்தம் எத்தனை எழுத்துக்கள் உள்ளன?", answer: "247" },
    ],
  },
];
